...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        function init() {
            ...
            if(!options.footerRowPosition){
                 options.footerRowPosition = 'bottom';
            } else {
                options.footerRowPosition = 'top';
            }
            ...
            if(options.footerRowPosition == "top"){
                              // footer Row
            ...
            // footer Row
            if(options.footerRowPosition == 'bottom') {
                $footerRowScrollerR = $("<div class='ui-state-default slick-footerrow' />").appendTo($paneTopR);
                $footerRowScrollerL = $("<div class='ui-state-default slick-footerrow' />").appendTo($paneTopL);
